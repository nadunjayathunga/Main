...
file_path = r'C:\Masters\Data-NBNH.xlsx'
...
fPurchase: pd.DataFrame = pd.read_excel(io=file_path, sheet_name='fPurchase', usecols=['ledger_code'])
...
dataframes: dict = {'dCoAAdler': dCoAAdler, 'dContract': dContract,'dCustomers': dCustomer,
                    'fGL': fGL, 'fCollection': fCollection,  'fCreditNote': fCreditNote,'fInv':fInv,'fAP':fAP ,'dEmployee':dEmployee,'fPurchase':fPurchase}
